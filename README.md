...
```javascript
utf16ToUTF8Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-utf16-to-utf8-array@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/string-utf16-to-utf8-array/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/string-utf16-to-utf8-array/actions/workflows/test.yml?query=branch:v0.2.3
